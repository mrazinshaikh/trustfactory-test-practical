...
const incrementQuantity = async (productId: number, currentQuantity: number): Promise<void> => {
...
const decrementQuantity = async (productId: number, currentQuantity: number): Promise<void> => {
    if (isUpdating.value !== null) {
        return;
    }
...
<template>
    <Dialog v-model:open="open">
        <DialogContent class="max-w-2xl">
            ...
            <div v-if="cartStore.itemCount === 0" class="flex flex-col items-center justify-center py-12">
            ...
            <template v-if="cartStore.itemCount > 0">
                <Separator />
                <DialogFooter class="flex-col gap-2 sm:flex-row sm:justify-between items-center">
                    <div class="flex flex-col items-start">
                        <p class="text-sm text-muted-foreground">Total</p>
                        <p class="text-2xl font-bold">${{ cartStore.totalPrice.toFixed(2) }}</p>
                    </div>
